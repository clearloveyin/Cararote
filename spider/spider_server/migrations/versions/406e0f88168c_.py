...
Revision ID: 406e0f88168c
Revises: 9842c9e1f035
Create Date: 2019-06-14 17:53:56.715900
...
revision = '406e0f88168c'
down_revision = '9842c9e1f035'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('role', sa.Column('type', sa.String(length=256), nullable=True))
