...
Revision ID: ffb79c971064
Revises: 53f17fda24b5
Create Date: 2019-06-13 09:29:10.081996
...
revision = 'ffb79c971064'
down_revision = '53f17fda24b5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('spec_catalog', sa.Column('precondition', sa.String(), nullable=True), schema='func')
    ...
    op.drop_column('spec_catalog', 'percondition', schema='func')
...
def downgrade():
    ...
    op.add_column('spec_catalog', sa.Column('percondition', sa.VARCHAR(), autoincrement=False, nullable=True), schema='func')
    ...
    op.drop_column('spec_catalog', 'precondition', schema='func')
