...
Revision ID: 9842c9e1f035
Revises: 49c73192a415
Create Date: 2019-06-13 09:43:20.999666
...
revision = '9842c9e1f035'
down_revision = '49c73192a415'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('spec_func', sa.Column('content', sa.String(), nullable=True), schema='func')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('spec_func', sa.Column('contents', sa.VARCHAR(), autoincrement=False, nullable=True), schema='func')
