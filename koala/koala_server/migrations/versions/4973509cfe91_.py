...
Revision ID: 4973509cfe91
Revises: 
Create Date: 2019-04-10 16:54:29.442275
...
def upgrade():
    ...
    op.create_table('project_observer',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('observer_id', sa.Integer(), nullable=True),
    sa.Column('proj_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['observer_id'], ['public.users.user_id'], ),
    sa.ForeignKeyConstraint(['proj_id'], ['func.projects.proj_id'], ),
...
def downgrade():
    ...
    op.drop_table('project_observer', schema='public')
    # ### end Alembic commands ###
