...
Revision ID: 29ca625a9ca1
Revises: 4973509cfe91
Create Date: 2019-07-18 11:14:49.305213
...
revision = '29ca625a9ca1'
down_revision = '4973509cfe91'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_constraint('project_observer_observer_id_fkey', 'project_observer', type_='foreignkey')
    op.drop_constraint('project_observer_proj_id_fkey', 'project_observer', type_='foreignkey')
    op.create_foreign_key(None, 'project_observer', 'projects', ['proj_id'], ['proj_id'], source_schema='public', referent_schema='func')
    op.create_foreign_key(None, 'project_observer', 'users', ['observer_id'], ['user_id'], source_schema='public', referent_schema='public')
    ...
    op.create_index('func_func_group_func_id_group_id_idx', 'func_group', ['func_id', 'group_id'], unique=True, schema='func')
...
def downgrade():
    ...
    op.drop_index('func_func_group_func_id_group_id_idx', table_name='func_group', schema='func')
    ...
    op.drop_constraint(None, 'project_observer', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'project_observer', schema='public', type_='foreignkey')
    op.create_foreign_key('project_observer_proj_id_fkey', 'project_observer', 'projects', ['proj_id'], ['proj_id'], referent_schema='func')
    op.create_foreign_key('project_observer_observer_id_fkey', 'project_observer', 'users', ['observer_id'], ['user_id'])
